...
const GROUPS: DocumentGroup[] = [
  { id: "g1", category_id: CATEGORY_ID, name_th: "0. แปลนและแบบก่อสร้าง", sort_order: 1, document_count: 12 },
  { id: "g2", category_id: CATEGORY_ID, name_th: "1.5 พื้นที่เก็บนอกอาคาร", sort_order: 2, document_count: 0 },
];
...
describe("dragging files onto the document uploader", () => {
  it("shows the drop zone with its instruction", () => {
    render(<DocUploader categoryId={CATEGORY_ID} groups={GROUPS} />);
